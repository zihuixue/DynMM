...
class ArgumentParserRGBDSegmentation(argparse.ArgumentParser):
    def set_common_args(self):
        ...
        self.add_argument('--finetune', default=None, type=str, help='path to the weights you want to finetune on.')
        ...
        self.add_argument('--lr', '--learning-rate', default=0.01, type=float, help='maximum learning rate. '
                        'When using one_cycle as --lr_scheduler lr will first increase to the value provided and then slowly decrease.')
        ...
        # model
        self.add_argument('--dynamic', action='store_true', help='dynamic NN')
        self.add_argument('--global-gate', action='store_true', help='dynamic NN with global gates')
        self.add_argument('--block-rule', type=str, default='1111',help='branch choice per block, 0: rgb, 1: rgb+d, 2: soft weight')
        self.add_argument('--temp', type=float, default=1, help='diff softmax temperature')
        self.add_argument('--end-temp', type=float, default=0.001, help='diff softmax end temperature')
        self.add_argument('--loss-ratio', type=float, default=0.0, help='flop loss ratio')
        self.add_argument('--flop-budget', type=float, default=0.0, help='flop resource constraint')
        self.add_argument('--epoch-ini', type=int, default=0, help='before how many epochs model ini')
        self.add_argument('--epoch-hard', type=int, default=500, help='after how many epochs set gate to be hard')
        self.add_argument('--eval-every', type=int, default=2, help='evaluate every epochs')
        self.add_argument('--save-every', type=int, default=100, help='evaluate every epochs')
        self.add_argument('--baseline', action='store_true', help='baseline')
        self.add_argument('--freeze', action='store_true', help='freeze everything but the soft gates')
        self.add_argument('--soft-eval', action='store_true', help='evalute using soft labels')
        ...
        self.add_argument('--encoder', type=str, default='resnet50',
